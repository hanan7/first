        ...
        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu  page-sidebar-menu-compact" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200"> 
            ...
            <li class="nav-item  ">
                <a href="{{URL('delegates/all-delegates')}}" class="nav-link nav-toggle">
                    <i class="icon-layers"></i>
                    <span class="title"> الوكلاء الرئسين</span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item  ">
                ...
                <ul class="sub-menu">
                    <li class="nav-item ">
                        <a href="{{URL('reports/page/products')}}" class="nav-link ">
                            <span class="title ">تقارير بضائع</span>
                        </a>
                    </li>
                    @if(Auth::guard('admins')->user()->flag==0 || Auth::guard('admins')->user()->flag==1)
                    <li class="nav-item ">
                        <a href="{{URL('reports/page/orders')}}" class="nav-link ">

                            <span class="title ">تقارير الطلبيات</span>
                        </a>
                    </li>
                    @endif    
                </ul>
