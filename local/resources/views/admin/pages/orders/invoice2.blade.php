...
<link href="{{asset('assets/admin/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('assets/admin/bootstrap-rtl.css')}}" rel="stylesheet" type="text/css" />
