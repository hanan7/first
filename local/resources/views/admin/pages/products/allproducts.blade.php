 ...
 @if(session()->has('success'))
  ...
  @endif 
    <div  class="alert alert-success">
      <ul>
         <li>
            برجاء الحفاظ على عدد ثلاثى للمنتجات لحفظ الشكل العام للموقع
          </li>
      </ul>
    </div> 
         ...
         <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
            ...
            @foreach($products as $pro)
              <tr>
                    ...
                    <td class="text-center"> <img src="{{url('uploads/products/'.$pro->image)  }}" style="width:80px; height:100px; "/></td>
...
@include('admin.pages.products.addproduct')
<!-- Modal -->
